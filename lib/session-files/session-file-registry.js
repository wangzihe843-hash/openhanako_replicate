...
function freezeEntry(raw) {
  return Object.freeze({
    ...
    ...(normalizeTranscription(raw.transcription, null, raw.updatedAt || raw.createdAt || Date.now()) ? {
      transcription: normalizeTranscription(raw.transcription, null, raw.updatedAt || raw.createdAt || Date.now()),
    } : {}),
  });
}
