...
export const PERSISTENT_STORES: readonly StoreDescriptor[] = Object.freeze([
  ...
  defineStore({
    ...
    checkpointPolicy: "Capture the complete Xingye tree for every agent, including reserved __user__ and __shared__ scopes, before any affected epoch migration. Business records, draft/history files, lore tombstones, and shared gift inventory are not regenerable caches.",
    ...
    identityContract: "agentId scopes every relative record path; __user__ and __shared__ are reserved owners. Event/draft IDs, peer IDs, and gift catalog keys remain identities inside their respective scopes.",
    ...
    siteRules: [
      ...
      ...rules(["shared/xingye-lore-memory-file.js"], "Writes managed stable-lore Markdown within the agent's Xingye tree.", ["mkdir", "write-file"]),
    ],
  }),
  defineStore({
    id: "agent-phone",
